...
Gem::Specification.new do |s|
  ...
  s.date = %q{2014-09-15}
  s.default_executable = %q{r10k}
  s.description = %q{    R10K provides a general purpose toolset for deploying Puppet environments and modules.
    It implements the Puppetfile format and provides a native implementation of Puppet
    dynamic environments.
}
  s.email = %q{adrien@somethingsinistral.net}
  s.executables = ["r10k"]
  ...
  s.homepage = %q{http://github.com/adrienthebo/r10k}
  s.licenses = ["Apache 2.0"]
  s.post_install_message = %q{NOTICE
======
...
information.
  ...
  s.summary = %q{Puppet environment and module deployment}
